...
![new-space](screenshots/space-jira.png)
...
![Epic enabled](screenshots/epic-enabled.png)
...
![s2 with sub-tasks](screenshots/s2.png)

---

#### Screenshot 6 — S4 showing all four Sub-tasks

[s4 with sub0-tasks](screenshots/s4.png)
...
![Backlog, story and label](screenshots/backlog-strory1.png)
![Backlog, story and label](screenshots/backlog-story2.png)
...
![selected strories before a sprint](screenshots/sprint-before-starting.png)

---

#### Screenshot 9 — Active Sprint board showing the started Sprint and Sprint Goal

![Before-starting=sprint](screenshots/creating-sprint.png)
![sprint started](screenshots/sprint-started.png)
...
![Filtered label from active sprint](screenshots/filtered-label-activesprint.png)

---

#### Screenshot 11 — Filter for label = devops showing the filtered results

![Filtered label devops](screenshots/filter-label-devops.png)
...
![burndown chart sprint1](screenshots/burndown-chart-sprin1.png)
