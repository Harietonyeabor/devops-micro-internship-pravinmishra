...
![index.html visible](screenshots/index.html-present.png)
...
![s3 bucket obj view](screenshots/s3-obj-view.png)
...
![static website endpoint](screenshots/endpoint-staticws.png)
...
![policy successful](screenshots/policy-sucessful.png)
...
![live browser using s3 bucket](screenshots/s3bucket-active.png)
...
![updated s3 browser](screenshots/updateds3-browser.png)
