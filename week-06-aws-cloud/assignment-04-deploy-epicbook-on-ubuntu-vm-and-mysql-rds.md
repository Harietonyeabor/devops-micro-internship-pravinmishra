...
![vpc details](scrrenshots/vpc-details.png)
...
![ssh login](screenshots/connected-ssh.png)
...
![output](screenshots/output-of-node-npm.png)

---

#### Screenshot 9 — Output of `systemctl status nginx`

![active nginx](screenshots/nginx-active.png)
...
![RDS Summary with no public accessibility](screenshots/public-accessiblility-no.png)

---

#### Screenshot 12 — Connectivity & security section showing the VPC and attached security group

![security section](screenshots/vpc-securitygroups.png)
...
![show table](screenshots/showtables.png)
...
![ls output](screenshots/epic-ls.png)
...
![tulpn output](screenshots/ss-tulpnoutput.png)
...
![success output](screenshots/nginx-t-ok.png)
