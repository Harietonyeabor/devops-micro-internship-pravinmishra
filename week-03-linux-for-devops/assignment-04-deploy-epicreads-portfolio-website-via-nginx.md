...
![alt text](active-and-running.png)
...
![alt text](enabled-health-check.png)

---

#### Screenshot 8 — Output of `curl -I http://localhost` showing 200 OK

![alt text](check-200.png)
