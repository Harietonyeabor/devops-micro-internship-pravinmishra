...
![tf version](screenshots/tf-version-2.png)
...
![aws version](screenshots/aws-vers-1.png)
...
![Hashicorp](screenshots/hashicorp-t-2.png)
...
![Project Structure](screenshots/tf-projstruc.png)
...
![vpc, public subnet and 2 privata db subnet config](screenshots/vpc-epic.png)
...
![internet gateway etc ](screenshots/int-gtway.png)
...
![ec2 and rds sec grp etc](screenshots/ec2-secgrp-tf.png)
...
![network module output](screenshots/network-mod.png)
...
![ec2 resource and user data config](screenshpts/ec2res-userdconfig.png)
...
![ec2 module variables and outputs](screenshots/ec2var-op.png)
...
![db subnet abd rds mysql config](screenshots/dbsubnet-rds.png)
...
![db info](screenshots/dbsubnet-rds-1.png)
...
![rds endpoint output](screenshots/rds-endpt.png)
...
![main.tf root module](screenshots/root-maintf.png)
...
![values passed from network](screenshots/values-passed.png)
...
![root ouputs](screenshots/ec2-publicip.png)
...
![tf validate](screenshots/init-azure-1.png)
...
![tf plan](screenshots/plan-aws.png)
...
![successful connection](screenshots/sql-bdaws.png)
...
EC2 Public IP URL
EC2 Public IP URL: 100.58.188.184
...
![database record](screenshots/sql-bdaws-1.png)
...
![tf destroy](screenshots/epic-tfd.png)
